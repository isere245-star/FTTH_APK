...
*GPS FAT :* ${form.GPS_Fat} \n
  ...
  const getLocation = async (prefix: "Fat" | "Client") => {
    ...
    if (status !== "granted") {
      Alert.alert(
        "Erreur",
        "Permission refusé, veuillez activer la localisation",
      );
      setTextField(null);
      return;
    }
    try {
      ...
      setForm((prev) => ({
        ...prev,
        [`GPS_${prefix}`]:
          String(latitude.toFixed(6)) + " , " + String(longitude.toFixed(6)),
      }));
    } catch (e) {
      Alert.alert("Erreur", "Localisation non détecté !");
    }
  ...
  const openPicker = (
    prefix: "Date" | "Signalisation" | "Intervention" | "Debut" | "Fin",
  ...
  return (
    <>
      ...
      {/* Conteneur principal de la fiche de dérangement */}
                ...
                <View style={styles.button_card}>
                  ...
                  <View style={styles.label}>
                    ...
                    >
                      ...
                      >
                        {" "}
                        {form.Date_Signalisation}
                      </Text>
                    </Pressable>
                  </View>

                  <View style={styles.label}>
                    <Text style={styles.text}> Date intervention </Text>
                    <Pressable
                      onPress={() => {
                        openPicker("Intervention", "date");
                      }}
                      style={styles.pressable}
                    >
                      <Text
                ...
                <View style={styles.button_card}>
                  ...
                  <View style={styles.label}>
                    ...
                    <TextInput
                      style={styles.inupt}
                      onChangeText={(text) =>
                        handleChange("TravauxEffectue", text)
                      }
                      multiline={true}
                      textAlignVertical="top"
                      numberOfLines={5}
