import { ScrollView, View, Text, Pressable, TextInput, StatusBar, StyleSheet , KeyboardAvoidingView, Platform, Alert, ActivityIndicator } from "react-native"
...
export default function Production () {
    ...
    const dateAffichee = date.toLocaleDateString ('fr-FR', {day: '2-digit', month: '2-digit', year: 'numeric'})
...
*GPS FAT:* ${form.GPS_FAT}
    ...
    const getLocation = async (prefix: 'FAT' | 'CLIENT' ) => {
        ...
        try {
            ...
            setForm( (prev) => ({
                ...prev,
                [`GPS_${prefix}`] : String(loc.coords.latitude.toFixed(6)) + ' , ' + String(loc.coords.longitude.toFixed(6))
            })
            )
            ...
            <SafeAreaView style = {styles.fond}>
                ...
                <KeyboardAvoidingView style = {styles.keyboard}>
                    ...
                    <ScrollView >
                        ...
                        <View style = {{flex: 0, width: '100%', alignItems: 'center', justifyContent: 'center', padding: 15}}>
                                ...
                                <View style = {styles.button_card}>
                                    ...
                                    <View style = {styles.label}>
                                        ...
                                        <Pressable style = {styles.pressable} onPress={ () => setShow (true)}>
                                            <Text style = {{color: '#94A3B8', fontWeight: 300, textAlign: 'center'}}> {dateAffichee} </Text>
                                        </Pressable>
                                ...
                                <View style = {styles.button_card}>
                                    ...
                                    <View style = {styles.label}>
                                        ...
                                        <TextInput 
                                            ...
                                            onChangeText={(text) => handleChange('PortDisponible', text)}  
                                        />
                                    </View>
                                    ...
                                    <View style = {styles.label}>
                                        ...
                                        <Dropdown
                                            ...
                                            placeholderStyle = {{
                                                color : '#94A3B8', fontWeight : 300,fontSize: 12}}
                                ...
                                <View style = {styles.button_card}>
                                    ...
                                    <View style = {styles.label}>
                                        ...
                                        <TextInput 
                                            ...
                                            onChangeText={(text) => handleChange('PuissanceFAT', text)}  
                                        />
                                    </View>
                                    ...
                                    <View style = {styles.label}>
                                        ...
                                        <TextInput 
                                            ...
                                            onChangeText={(text) => handleChange('PuissancePTO', text)}  
                                        />
                                    </View>
                                ...
                                <View style = {styles.button_card}>
                                    ...
                                    <View style = {styles.label}>
                                        ...
                                        <TextInput 
                                            ...
                                            onChangeText={(text) => handleChange('PoteauxTraverser', text)}  
                                        />
                                    </View>
                                    ...
                                    <View style = {styles.label}>
                                        ...
                                        <TextInput 
                                            ...
                                            onChangeText={(text) => handleChange('PoteauxImplanter', text)}  
                                        />
                                    </View>
                                    ...
                                    <View style = {styles.label}>
                                        ...
                                        <TextInput 
                                            ...
                                            onChangeText={(text) => handleChange('PoteauxSBEEArmes', text)}  
                                        />
                                    </View>
